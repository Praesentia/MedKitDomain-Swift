...
public protocol AccountManagerBackendDelegate: class {
    ...
    func accountManager(_ manager: AccountManagerBackend, addAccountWith identity: Identity, description: String?, secret: Data, completionHandler completion: @escaping (Account?, Error?) -> Void)
